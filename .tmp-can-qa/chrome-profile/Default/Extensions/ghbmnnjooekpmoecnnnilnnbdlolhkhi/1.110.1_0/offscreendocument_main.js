...
function v(a, b) {
  if (b)
    a: {
      ...
      d = c[a];
      b = b(d);
      b != d && b != null && da(c, a, { configurable: !0, writable: !0, value: b });
    }
}
var ha;
      ...
      if (c) var d = va(a, c, b, a.j.B);
        ...
        try {
          (b["return"] && ((d = b["return"]()), pa(d)),
            ra(a.j, new TypeError("The iterator does not provide a 'throw' method.")));
        } catch (e) {
          ra(a.j, e);
        }
        d = wa(a);
...
function Ga(a) {
  a = a.split(".");
  for (var b = A, c = 0; c < a.length; c++) if (((b = b[a[c]]), b == null)) return null;
  return b;
}
function Ha(a) {
  var b = typeof a;
...
function fc() {
  ...
  b & 2147483648
    ? rb()
      ...
      : ((b = y(cc(a, b))), (a = b.next().value), (b = b.next().value), (a = "-" + dc(a, b)))
    : (a = dc(a, b));
  return a;
}
function cc(a, b) {
  ...
  if (a.length < 16) bc(Number(a));
    ...
    for (var c = a.length, d = 0 + b, e = ((c - b) % 6) + b; e <= c; d = e, e += 6)
      ((d = Number(a.slice(d, e))),
        ($b *= 1e6),
        (I = I * 1e6 + d),
        I >= 4294967296 && (($b += Math.trunc(I / 4294967296)), ($b >>>= 0), (I >>>= 0)));
...
function Kc(a, b) {
  ...
  if (a != null && a[Ab] === Hb)
    return ((b = a.C), (c = b[G] | 0), Ib(a, c) ? a : Mc(a, b, c) ? Nc(a, b) : Lc(b, c));
...
function Xc(a, b, c, d, e, f, g, h) {
  ...
  f === 1 || (f !== 4 ? 0 : 2 & b || (!(16 & b) && 32 & d))
    ...
    : (f === 2 &&
        Yc(b) &&
        ((a = Array.prototype.slice.call(a)), (k = 0), (b = Zc(b, d)), (d = Wc(c, d, e, a))),
...
function nd(a, b, c, d) {
  if (d != null) {
    if (!(d instanceof b))
      throw Error("Expected instanceof " + mc(b) + " but got " + (d && mc(d.constructor)));
  } else d = void 0;
  Vc(a, c, d);
  d && !Ib(d) && Rc(a.C);
  return a;
  ...
  try {
    ...
    if (rd(a, 1).split("/").pop() != e) var f = null;
      ...
      if (l != null && !(Array.isArray(l) || (l != null && l[Ab] === Hb)))
        throw Error("saw an invalid value of type '" + Ha(l) + "' in the Any.value field");
      var m = wc(l, g, !0, k);
      if (!(m instanceof g))
        throw Error(
...
O.prototype.ya = function () {
  return (
    this.A ||
    (Object.defineProperties(this, { A: { value: (le = (le + 1) | 0), enumerable: !1 } }), this.A)
  );
};
...
function bf(a, b) {
  ...
  } else if (b && ((a = b.ba.Cb), a !== void 0)) for (b = 0; b < c; b++) d[b] = a;
  return d;
}
function Ce(a, b, c) {
  var d;
...
function me(a) {
  return a.l != 0
    ? P(ef("[", a.l)) +
        P(a.j.prototype.D[1] == 3 ? a.j.prototype.D[2] : "L" + P(a.j.prototype.D[0]) + ";")
    : a.j.prototype.D[0];
}
function ff(a, b) {
  ...
  var c = (a.length + 1) | 0;
  if (b < 0 || b >= c)
    throw ((a = new Le()), (a.l = "Index: " + b + ", Size: " + c), T(a), S(a, Error(a)), a.j);
  return a.substr(b);
}
...
function zf() {
  ...
  try {
    var b = aa();
    a = wf.createPolicy("goog#html", { createHTML: b, createScript: b, createScriptURL: b });
  } catch (c) {}
  return a;
}
function Af(a) {
...
function Yf(a, b, c) {
  if (Array.isArray(b)) for (var d = 0; d < b.length; d++) Yf(a, String(b[d]), c);
    ...
    if (a.o) {
      ...
      if (c.l) {
        ...
        e &&
          (c.j == 0 && d == 1
            ? Kg(c, b)
            : (f ? ((d = f), d.next == c.v && (c.v = d), (d.next = d.next.next)) : Lg(c),
              Mg(c, e, 3, b)));
      }
      a.o = null;
    } else xg(a, 3, b);
  ...
  for (var d = (c = !1); a.A.length && !a.I;) {
    ...
    if ((f = a.v ? g : f))
      try {
        ...
        if (vg(b) || (typeof A.Promise === "function" && b instanceof A.Promise))
          ((d = !0), (a.I = !0));
      } catch (k) {
        ((b = k), (a.v = !0), dh(a) || (c = !0));
      }
...
function xh(a) {
  if (!(((a.l.get(null) + 1) | 0) / V(a.l.o / 1e3) <= a.o))
    throw new uh("Query would cause " + P(a.G) + " to exceed " + a.o + " qps.").j;
  a = a.l;
...
q.la = function () {
  for (
    var a = this.j.length, b = (this.j.length - this.j.length) | 0, c = U([], mf, lf);
    b < a;
    b = (b + 1) | 0
  ) {
    var d = c,
...
function Rh(a, b) {
  for (var c, d, e = 1; e < arguments.length; e++) {
    ...
    for (var f = 0; f < Qh.length; f++)
      ((c = Qh[f]), Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]));
  }
}
function Sh(a) {
...
Sh.prototype.toString = function () {
  ...
  if ((c = this.l))
    (this.j && c.charAt(0) != "/" && a.push("/"), a.push(Zh(c, c.charAt(0) == "/" ? ai : bi, !0)));
...
function Zh(a, b, c) {
  return typeof a === "string"
    ? ((a = encodeURI(a).replace(b, fi)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a)
    : null;
}
function fi(a) {
  a = a.charCodeAt(0);
...
q.remove = function (a) {
  ...
  a = hi(this, a);
  return this.j.has(a)
    ? ((this.o = null), (this.l = this.l - this.j.get(a).length), this.j.delete(a))
    : !1;
};
q.clear = function () {
  this.j = this.o = null;
...
function Bi(a, b, c, d, e, f) {
  ...
  if (a.addEventListener)
    (mi || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(), d, e));
  ...
  var e = $g(
    $g(
      ...
      function (f) {
        if (!(f >= this.ea))
          return (
            this.O && (a = W(a, "errorSender_enqueueTimeMs", Date.now().toString())),
            (f = {}),
            (f.u = a),
            (f.m = b),
            (f.c = c),
...
function bj(a, b) {
  ...
  try {
    ...
    a.O &&
      ...
      b.errorSender_frontIndex && (c = W(c, "errorSender_frontIndex", b.errorSender_frontIndex)),
      b.errorSender_nextIndex && (c = W(c, "errorSender_nextIndex", b.errorSender_nextIndex)),
...
tj.prototype.fa = function () {
          ...
          : oc(b)
            ? g === "string"
              ? ((f = b),
                ...
                ic(b)
                  ? (f = String(b))
                  : ((b = f.indexOf(".")), b !== -1 && (f = f.substring(0, b)), (f = rc(f))))
              : (f = f ? tc(b) : sc(b))
            : (f = void 0);
      e = d(f != null ? f : e);
      c = pd(c, 2);
  ...
  var h, k;
  (e = (h = this.j) == null ? void 0 : (k = ld(h, nj, 1)) == null ? void 0 : sd(k, 6)) &&
  ...
  try {
    for (; !c.done; c = b.next()) {
      var g = c.value,
        h = Bj(g.key);
      h === 0
        ? (a.set("apps_telemetry.automation_property_present." + g.T, "true"), (e = !0))
  ...
  try {
    for (; !h.done; h = g.next()) {
      ...
      if (!r.ca) {
        ...
        t === "non_function_type" &&
          a.set("apps_telemetry.native_function_tampering." + m + ".type", r.type);
        f = !0;
      }
    }
  } finally {
...
gk.prototype.j = function (a) {
  var b = Wj(a);
  return hk(a.message, this.l) || hk(a.j, this.o) || hk(b, this.l) || hk(b, this.o)
    ? "warning"
    : null;
};
function hk(a, b) {
