  ...
  ((i = new (function () {
    ...
    ((this.proxy = o.proxy.bind(this)),
            ...
            this.proxy(function () {
              t.sso_url(o).then(
                this.proxy(function (t) {
                  i
                    ? (e.isChrome() && chrome.tabs.update(i, { url: t.uri, active: !0 }),
                      (i = null))
                    : e.createTab(t.uri);
                }),
                this.proxy(function (r) {
                  ((o = t.settings.cloud_host + o),
                    i
                      ? (e.isChrome() && chrome.tabs.update(i, { url: o, active: !0 }), (i = null))
                      : e.createTab(o));
                }),
              );
            }),
      ...
      (this.message = function (t, o, r) {
        i &&
          e.sendMessage({ tabId: i, progress_op: r ? "set-error" : "set-text", text: t, busy: o });
      }),
              ...
              e
                .ajax({
                  ...
                  data: JSON.stringify({
                    ...
                    metadata: ["id", "name", "created", "parent_id"],
                  }),
                })
                .then(
      ...
      (this.newSession = function (t, o, r) {
        (r || (r = f.params),
          ...
          t ||
            (e.isChrome() &&
              (t = chrome.runtime.getURL("browser/js/progress.html") + "#" + e.param(r)),
            r.filename && this.send_folders()),
          i
      ...
      (this.getAonlineURL = function (o) {
        ...
        return (
          i && _
            ...
            : i
              ? (i += "online.html")
              : (i = _ ? a[n] + "acrobat/" + _ + b : a[n] + "acrobat/online.html"),
