...
var dc = {
  ...
  registerURI: function (e, t, r) {
    ...
    return (
      ...
      (t = dc.resolveURL(e, t)),
      dc.URIs[t] ||
        ((dc.URIs[t] = { placeholder: c + dc.uriCounter.toString() + n }), (dc.uriCounter += 1)),
      dc.URIs[t]
    );
  },
  ...
  replaceCssRefs: function (e, t, r) {
    ...
    for (t = t.replace(/\/\*[\s\S]*?\*\//gm, ""), c = i.exec(t); c;)
      ((n = (s = c[2]).replace(/('|")/g, "")),
        s &&
          0 !== n.indexOf("data:") &&
          o.push({ url: n, imprt: -1 !== c[1].indexOf("@import"), originalURL: s }),
        (c = i.exec(t)));
    return (
      o.forEach(
        dc.wrap(function (e) {
          ...
          if (this.status < 400) {
            ...
            (((t = new FileReader()).onloadend = function (e) {
              ((s.type = "css"),
                ...
                s.promise.time_out ||
                  ((s.data = dc.replaceCssRefs(n, e.target.result, r)), s.promise.resolve()));
            }),
              t.readAsText(this.response));
          } else
            (dc.log("CSS FAILED to load: " + c.responseURL + "   Placeholder: " + s.placeholder),
              s.promise.resolve());
        }, c)),
        c.send()),
      s.placeholder
        ...
        for (r = 0; r < window.frames.length; r += 1)
          window.frames[r] === t.contentWindow &&
            (t.contentWindow.WINDOW_ID
              ? ((dc.iframesToProcess[r] = { index: r }),
                (e.src = t.contentWindow.WINDOW_ID + ".html"))
              : (e.src = "about:blank"));
    ...
    if (
      ...
      try {
        ...
        (dc.analytics.push("TAINTED_CANVAS"),
          ((c = document.createElement("DIV")).className = e.className));
      }
      ...
      "image" === e.tagName &&
        (function (e) {
          var t,
            ...
            n = c.length;
          for (t = 0; t < n; t += 1)
            ("href" !== (r = c[t]).localName && "src" !== r.localName) ||
  ...
  htmlTree: function (e) {
    ...
    function t(e) {
      return (
        ...
        ("LINK" !== e.tagName ||
          !e.rel ||
          -1 !== e.rel.indexOf("stylesheet") ||
          -1 !== e.rel.indexOf("icon")) &&
        ("IMG" !== e.tagName || 1 !== e.width || 1 !== e.height) &&
        ("PARAM" === e.tagName &&
          "application/x-shockwave-flash" === e.parentElement.type &&
          (dc.topWindow ? dc.analytics.push("FLASH") : dc.analytics.push("FLASH_IN_IFRAME")),
        "IFRAME" !== e.tagName || !e.src || 0 !== e.src.indexOf("chrome-extension://"))
      );
    }
    var r, c, n;
    if (((r = e.cloneNode(!1)), (r = dc.resolveRefs(r, e)), e.hasChildNodes()))
      for (c = e.firstChild; c;)
        (t(c) && ((n = dc.htmlTree(c)), r.appendChild(n)), (c = c.nextSibling));
    return r;
  },
      ...
      (function e() {
        return (
          dc.Deferred.all(dc.promises).done(
            dc.wrap(function () {
              (dc.processIframes(),
                dc.promises.length === r ? c.resolve() : ((r = dc.promises.length), e()));
            }),
          ),
          c.promise()
        );
