...
window.domUtils = {
    ...
    return (
      ...
      t &&
        (function (e) {
          ...
          return 0 !== t.indexOf("javascript:") && 0 !== t.indexOf("data:");
        })(t) &&
        (r.src = t),
  ...
  appendTo: function (e, t) {
    var n = "string" == typeof t ? document.querySelector(t) || document.documentElement : t;
    return (n && e && n.appendChild(e), e);
  },
  attachZoomPrevention: function (e) {
    e &&
