  ...
  (e = function () {
    ...
    var C,
      M =
        ((C = 0),
        function () {
          return d + "__lottie_element_" + (C += 1);
        });
    function T(t, e, i) {
      var s, a, r, n, o, h, l, p;
      switch (
    ...
    function E(t, e) {
      var i = F(255 * t[0], 255 * t[1], 255 * t[2]);
      return ((i[1] += e), i[1] > 1 ? (i[1] = 1) : i[1] <= 0 && (i[1] = 0), T(i[0], i[1], i[2]));
    }
    function I(t, e) {
      var i = F(255 * t[0], 255 * t[1], 255 * t[2]);
      return ((i[2] += e), i[2] > 1 ? (i[2] = 1) : i[2] < 0 && (i[2] = 0), T(i[0], i[1], i[2]));
    }
    function L(t, e) {
      var i = F(255 * t[0], 255 * t[1], 255 * t[2]);
      return (
                  ...
                  (n.assetLoader = (function () {
                    function t(t) {
                      ...
                      return (e && "json" === t.responseType && -1 !== e.indexOf("json")) ||
                        (t.response && "object" === N(t.response))
                        ? t.response
        ...
        return (
          (o.prototype = {
            ...
            createImageData: function (e) {
              var i = s(e, this.assetsPath, this.path),
                a = O("image");
              (m ? this.testImageLoaded(a) : a.addEventListener("load", this._imageLoaded, !1),
                a.addEventListener(
                  "error",
                  function () {
    ...
    var G = function () {
      ((this._cbs = []),
        ...
        (this.drawnFrameEvent = new k("drawnFrame", 0, 0, 0)),
    ...
    (r([j], G),
        ...
        ((this.renderer = new i(this, t.rendererSettings)),
          ...
          t.animationData
            ...
            : t.path &&
              ...
              B.loadAnimation(t.path, this.configAnimation, this.onSetupError)));
      }),
      (G.prototype.onSetupError = function () {
        this.trigger("data_failed");
      }),
      (G.prototype.setupAnimation = function (t) {
        B.completeAnimation(t, this.configAnimation);
      }),
      (G.prototype.setData = function (t, e) {
        e && "object" !== Y(e) && (e = JSON.parse(e));
                ...
                : s.getNamedItem("data-bm-renderer")
                  ...
                  : s.getNamedItem("bm-renderer")
                    ...
                    : (function () {
                        ...
                        for (var t in H) if (H[t]) return t;
                        return "";
                      })() || "canvas"));
      ...
      (G.prototype.includeLayers = function (t) {
        ...
        ((this.animationData.__complete = !1),
          B.completeAnimation(this.animationData, this.onSegmentComplete));
      }),
      (G.prototype.onSegmentComplete = function (t) {
        this.animationData = t;
        var e = V();
        (e && e.initExpressions(this), this.loadNextSegment());
      }),
      (G.prototype.loadNextSegment = function () {
      ...
      (G.prototype.loadSegments = function () {
        (this.animationData.segments || (this.timeCompleted = this.totalFrames),
          this.loadNextSegment());
      }),
      (G.prototype.imagesLoaded = function () {
        (this.trigger("loaded_images"), this.checkLoaded());
      }),
      (G.prototype.preloadImages = function () {
      ...
      (G.prototype.waitForFontsLoaded = function () {
        this.renderer &&
          (this.renderer.globalData.fontManager.isLoaded
            ? this.checkLoaded()
            : setTimeout(this.waitForFontsLoaded.bind(this), 20));
      }),
      (G.prototype.checkLoaded = function () {
        if (
          !this.isLoaded &&
          this.renderer.globalData.fontManager.isLoaded &&
      ...
      (G.prototype.setSubframe = function (t) {
        this.isSubframeEnabled = !!t;
      }),
      (G.prototype.gotoFrame = function () {
      ...
      (G.prototype.renderFrame = function () {
      ...
      (G.prototype.togglePause = function (t) {
      ...
      (G.prototype.getMarkerData = function (t) {
        for (var e, i = 0; i < this.markers.length; i += 1)
          if ((e = this.markers[i]).payload && e.payload.name === t) return e;
        return null;
      }),
      (G.prototype.goToAndStop = function (t, e, i) {
        if (!i || this.name === i) {
          var s = Number(t);
          if (isNaN(s)) {
      ...
      (G.prototype.goToAndPlay = function (t, e, i) {
        if (!i || this.name === i) {
          var s = Number(t);
          if (isNaN(s)) {
            var a = this.getMarkerData(t);
      ...
      (G.prototype.advanceTime = function (t) {
      ...
      (G.prototype.adjustSegment = function (t, e) {
        ((this.playCount = 0),
          t[1] < t[0]
      ...
      (G.prototype.setSegment = function (t, e) {
        var i = -1;
        (this.isPaused &&
      ...
      (G.prototype.playSegments = function (t, e) {
        if ((e && (this.segments.length = 0), "object" === Y(t[0]))) {
          var i,
            s = t.length;
      ...
      (G.prototype.resetSegments = function (t) {
        ((this.segments.length = 0),
          this.segments.push([this.animationData.ip, this.animationData.op]),
          t && this.checkSegments(0));
      }),
      (G.prototype.checkSegments = function (t) {
      ...
      (G.prototype.setCurrentRawFrameValue = function (t) {
        ((this.currentRawFrame = t), this.gotoFrame());
      }),
      (G.prototype.setSpeed = function (t) {
        ((this.playSpeed = t), this.updaFrameModifier());
      }),
      (G.prototype.setDirection = function (t) {
        ((this.playDirection = t < 0 ? -1 : 1), this.updaFrameModifier());
      }),
      (G.prototype.setLoop = function (t) {
        this.loop = t;
      }),
      (G.prototype.setVolume = function (t, e) {
        (e && this.name !== e) || this.audioController.setVolume(t);
      }),
      (G.prototype.getVolume = function () {
        return this.audioController.getVolume();
      }),
      (G.prototype.mute = function (t) {
        (t && this.name !== t) || this.audioController.mute();
      }),
      (G.prototype.unmute = function (t) {
        (t && this.name !== t) || this.audioController.unmute();
      }),
      (G.prototype.updaFrameModifier = function () {
      ...
      (G.prototype.getAssetsPath = function (t) {
        var e = "";
        if (t.e) e = t.p;
      ...
      (G.prototype.getAssetData = function (t) {
      ...
      (G.prototype.getDuration = function (t) {
        return t ? this.totalFrames : this.totalFrames / this.frameRate;
      }),
      (G.prototype.updateDocumentData = function (t, e, i) {
        try {
      ...
      (G.prototype.trigger = function (t) {
        if (this._cbs && this._cbs[t])
          switch (t) {
            case "enterFrame":
              this.triggerEvent(
                t,
                new k(t, this.currentFrame, this.totalFrames, this.frameModifier),
              );
              break;
            case "drawnFrame":
            ...
            case "complete":
              ...
              break;
            case "segmentStart":
              this.triggerEvent(t, new S(t, this.firstFrame, this.totalFrames));
              break;
            case "destroy":
        ...
        ("enterFrame" === t &&
          ...
          this.onEnterFrame.call(
            this,
            new k(t, this.currentFrame, this.totalFrames, this.frameMult),
          ),
          "loopComplete" === t &&
            this.onLoopComplete &&
            this.onLoopComplete.call(this, new A(t, this.loop, this.playCount, this.frameMult)),
          "complete" === t &&
            this.onComplete &&
            this.onComplete.call(this, new P(t, this.frameMult)),
          "segmentStart" === t &&
            this.onSegmentStart &&
            this.onSegmentStart.call(this, new S(t, this.firstFrame, this.totalFrames)),
          "destroy" === t && this.onDestroy && this.onDestroy.call(this, new x(t, this)));
      }),
      (G.prototype.triggerRenderFrameError = function (t) {
        var e = new w(t, this.currentFrame);
        (this.triggerEvent("error", e), this.onError && this.onError.call(this, e));
      }),
      (G.prototype.triggerConfigError = function (t) {
    ...
    var K = (function () {
      ...
      Z = function (t, e, i) {
        ...
        return {
          ...
          release: function (t) {
            (s === a && ((r = U.double(r)), (a *= 2)), i && i(t), (r[s] = t), (s += 1));
          },
        };
      },
      Q = Z(8, function () {
        return { addedLength: 0, percents: h("float32", z()), lengths: h("float32", z()) };
      }),
      $ = Z(
        8,
        function () {
        ...
        function (t) {
          var e,
            i = t.lengths.length;
          for (e = 0; e < i; e += 1) Q.release(t.lengths[e]);
          t.lengths.length = 0;
        },
      ),
      tt = (function () {
          ...
          for (n = i.length, a = 0; a < p; a += 1) {
            for (h = a / (p - 1), l = 0, r = 0; r < n; r += 1)
              ((o =
                ...
                c(h, 3) * e[r]),
                (d[r] = o),
                null !== m[r] && (l += c(d[r] - m[r], 2)),
                (m[r] = d[r]));
            (l && (f += l = u(l)), (g.percents[a] = h), (g.lengths[a] = f));
          }
          return ((g.addedLength = f), g);
        };
        function s(t) {
            ...
            function (t, i, n, o) {
              ...
              if (!r[h]) {
                ...
                for (d = n.length, p = 0; p < b; p += 1) {
                  for (v = l(d), g = p / (b - 1), y = 0, f = 0; f < d; f += 1)
                    ((m =
                      c(1 - g, 3) * t[f] +
                      3 * c(1 - g, 2) * g * (t[f] + n[f]) +
                      3 * (1 - g) * c(g, 2) * (i[f] + o[f]) +
                      c(g, 3) * i[f]),
                      (v[f] = m),
                      null !== k && (y += c(v[f] - k[f], 2)));
                  ((_ += y = u(y)), (P.points[p] = new a(y, v)), (k = v));
                }
    ...
    function st(t, e) {
      ...
      var v,
        ...
        T = a.t - s;
      if (a.to) {
        n.bezierData || (n.bezierData = tt.buildBezierData(a.s, r.s || a.e, a.to, a.ti));
        var F = n.bezierData;
        if (t >= M || t < T) {
          ...
          (n.__fnct
            ? (m = n.__fnct)
            : ((m = J.getBezierEasing(a.o.x, a.o.y, a.i.x, a.i.y, a.n).get), (n.__fnct = m)),
            (p = m((t - T) / (M - T))));
          var I,
            L = F.segmentLength * p,
          ...
          for (
            ...
            if (
              ((V += F.points[d].partialLength), 0 === L || 0 === p || d === F.points.length - 1)
            ) {
        ...
        if (((g = a.s.length), (v = r.s || a.e), this.sh && 1 !== a.h))
          if (t >= M) ((i[0] = v[0]), (i[1] = v[1]), (i[2] = v[2]));
            ...
            ((_ = i),
              ...
              (S = k[2]),
              (x = k[3]),
              (w = Math.atan2(2 * A * x - 2 * P * S, 1 - 2 * A * A - 2 * S * S)),
              (D = Math.asin(2 * P * A + 2 * S * x)),
              (C = Math.atan2(2 * P * x - 2 * A * S, 1 - 2 * P * P - 2 * S * S)),
              (_[0] = w / b),
              (_[1] = D / b),
              (_[2] = C / b));
          }
                      ...
                      ? (n.__fnct || (n.__fnct = []),
                        n.__fnct[u]
                          ...
                          : ((R = void 0 === a.o.x[u] ? a.o.x[0] : a.o.x[u]),
                            ...
                            (m = J.getBezierEasing(R, z, O, N).get),
                            (n.__fnct[u] = m)))
                      : n.__fnct
                        ? (m = n.__fnct)
                        : ((R = a.o.x),
    ...
    function nt(t) {
      ...
      if ("unidimensional" === this.propType)
        ((e = t * this.mult), it(this.v - e) > 1e-5 && ((this.v = e), (this._mdf = !0)));
      else
        for (var i = 0, s = this.v.length; i < s;)
          ((e = t[i] * this.mult),
            it(this.v[i] - e) > 1e-5 && ((this.v[i] = e), (this._mdf = !0)),
            (i += 1));
    }
    function ot() {
    ...
    function pt(t, e, i, s) {
      ...
      var r = e.k.length;
      for (
        this.v = h("float32", r), this.pv = h("float32", r), this.vel = h("float32", r), a = 0;
        a < r;
        a += 1
      )
    ...
    function ft(t, e, i, s) {
      ((this.propType = "unidimensional"),
        ...
        (this.frameId = -1),
        (this._caching = { lastFrame: et, lastIndex: 0, value: 0, _lastKeyframeIndex: -1 }),
        (this.k = !0),
        (this.kf = !0),
        (this.data = e),
        (this.mult = i || 1),
        ...
        (this.getValue = ot),
        (this.setVValue = nt),
        (this.interpolateValue = st),
        (this.effectsSequence = [rt.bind(this)]),
        (this.addEffect = ht));
    }
    function dt(t, e, i, s) {
      var a;
      ...
      for (a = 0; a < p - 1; a += 1)
        e.k[a].to &&
          ...
          ((2 === r.length &&
            (r[0] !== n[0] || r[1] !== n[1]) &&
            tt.pointOnLine2D(r[0], r[1], n[0], n[1], r[0] + o[0], r[1] + o[1]) &&
            tt.pointOnLine2D(r[0], r[1], n[0], n[1], n[0] + l[0], n[1] + l[1])) ||
            (3 === r.length &&
      ...
      for (this.v = h("float32", f), this.pv = h("float32", f), a = 0; a < f; a += 1)
        ((this.v[a] = et), (this.pv[a] = et));
      ((this._caching = { lastFrame: et, lastIndex: 0, value: h("float32", f) }),
        (this.addEffect = ht));
    }
    var mt = {
      getProp: function (t, e, i, s, a) {
        ...
        if ((e.sid && (e = t.globalData.slotManager.getProp(e)), e.k.length))
          if ("number" == typeof e.k[0]) r = new pt(t, e, s, a);
          else
            switch (i) {
              case 0:
                r = new ft(t, e, s, a);
    ...
    ((gt.prototype.setPathData = function (t, e) {
      ...
      for (var i = 0; i < e;)
        ((this.v[i] = ut.newElement()),
          (this.o[i] = ut.newElement()),
          (this.i[i] = ut.newElement()),
          (i += 1));
    }),
      ...
      (gt.prototype.setXYAt = function (t, e, i, s, a) {
        var r;
        switch (
        ...
        ((!r[s] || (r[s] && !a)) && (r[s] = ut.newElement()), (r[s][0] = t), (r[s][1] = e));
      }),
      (gt.prototype.setTripleAt = function (t, e, i, s, a, r, n, o) {
      ...
      (gt.prototype.reverse = function () {
        ...
        var e = this.v,
          ...
          a = 0;
        this.c &&
          (t.setTripleAt(e[0][0], e[0][1], s[0][0], s[0][1], i[0][0], i[0][1], 0, !1), (a = 1));
        var r,
          n = this._length - 1,
          o = this._length;
        for (r = a; r < o; r += 1)
    ...
    ((bt.prototype.addShape = function (t) {
      ...
      (bt.prototype.releaseShapes = function () {
        var t;
      ...
      St =
        ((_t = {
          newShapeCollection: function () {
            return kt ? At[(kt -= 1)] : new bt();
          },
          release: function (t) {
            var e,
              i = t._length;
            for (e = 0; e < i; e += 1) vt.release(t.shapes[e]);
            ((t._length = 0),
              kt === Pt && ((At = U.double(At)), (Pt *= 2)),
              (At[kt] = t),
              (kt += 1));
          },
        }),
      ...
      xt = (function () {
          ...
          if (t < m[0].t - this.offsetTime) ((s = m[0].s[0]), (r = !0), (d = 0));
            ...
            if (((g = this.keyframesMetadata[y] || {}), (d = y), !(r = 1 === c.h))) {
              if (t >= u.t - this.offsetTime) p = 1;
                ...
                (g.__fnct
                  ? (_ = g.__fnct)
                  : ((_ = J.getBezierEasing(c.o.x, c.o.y, c.i.x, c.i.y).get), (g.__fnct = _)),
                  (p = _(
        ...
        function o(t, e, i) {
          ...
          ((this.v = vt.clone(a)),
            ...
            (this.localShapeCollection = St.newShapeCollection()),
            (this.paths = this.localShapeCollection),
        ...
        var p = (function () {
            ...
            function e(t, e) {
              ((this.v = vt.newElement()),
                ...
                (this.p = mt.getProp(t, e.p, 1, 0, this)),
                (this.s = mt.getProp(t, e.s, 1, 0, this)),
          ...
          f = (function () {
            function t(t, e) {
              ((this.v = vt.newElement()),
                ...
                this.initDynamicPropertyContainer(t),
                1 === e.sy
                  ? ((this.ir = mt.getProp(t, e.ir, 0, 0, this)),
                    (this.is = mt.getProp(t, e.is, 0, 0.01, this)),
                    (this.convertToPath = this.convertStarToPath))
                  : (this.convertToPath = this.convertPolygonToPath),
                (this.pt = mt.getProp(t, e.pt, 0, 0, this)),
                (this.p = mt.getProp(t, e.p, 1, 0, this)),
                (this.r = mt.getProp(t, e.r, 0, b, this)),
                (this.or = mt.getProp(t, e.or, 0, 0, this)),
                (this.os = mt.getProp(t, e.os, 0, 0.01, this)),
                (this.localShapeCollection = St.newShapeCollection()),
                this.localShapeCollection.addShape(this.v),
                (this.paths = this.localShapeCollection),
                this.dynamicProperties.length
          ...
          d = (function () {
            function t(t, e) {
              ((this.v = vt.newElement()),
                ...
                (this.p = mt.getProp(t, e.p, 1, 0, this)),
                (this.s = mt.getProp(t, e.s, 1, 0, this)),
                (this.r = mt.getProp(t, e.r, 0, 0, this)),
                this.dynamicProperties.length
                  ? (this.k = !0)
    ...
    ((Ct.play = K.play),
      (Ct.pause = K.pause),
      (Ct.setLocationHref = function (e) {
        t = e;
      }),
      (Ct.togglePause = K.togglePause),
      (Ct.setSpeed = K.setSpeed),
      (Ct.setDirection = K.setDirection),
      (Ct.stop = K.stop),
      (Ct.searchAnimations = Mt),
      (Ct.registerAnimation = K.registerAnimation),
      (Ct.loadAnimation = function (t) {
        return K.loadAnimation(t);
      }),
      (Ct.setSubframeRendering = function (t) {
        !(function (t) {
          p = !!t;
        })(t);
      }),
      (Ct.resize = K.resize),
      (Ct.goToAndStop = K.goToAndStop),
      (Ct.destroy = K.destroy),
      (Ct.setQuality = function (t) {
        if ("string" == typeof t)
          switch (t) {
            case "high":
              R(200);
        ...
        else !isNaN(t) && t > 1 && R(t);
      }),
      (Ct.inBrowser = function () {
        return "undefined" != typeof navigator;
      }),
      (Ct.installPlugin = function (t, e) {
        "expressions" === t && (f = e);
      }),
      (Ct.freeze = K.freeze),
      (Ct.unfreeze = K.unfreeze),
      (Ct.setVolume = K.setVolume),
      (Ct.mute = K.mute),
      (Ct.unmute = K.unmute),
      (Ct.getRegisteredAnimations = K.getRegisteredAnimations),
      (Ct.useWebWorker = function (t) {
        e = !!t;
      }),
      (Ct.setIDPrefix = function (t) {
        d = t;
      }),
      (Ct.__getFactory = function (t) {
        switch (t) {
      ...
      (Ct.version = "5.13.0"));
    var Tt = "",
      Ft = document.getElementsByTagName("script"),
      Et = Ft[Ft.length - 1] || { src: "" };
    ((Tt = Et.src ? Et.src.replace(/^[^\?]+\??/, "") : ""),
      (function (t) {
    ...
    var It = setInterval(function () {
      "complete" === document.readyState && (clearInterval(It), Mt());
    }, 100);
    try {
      ("object" === ("undefined" == typeof exports ? "undefined" : Dt(exports)) &&
    ...
    function Rt() {}
    function zt() {}
    ((Vt.prototype.initModifierProperties = function () {}),
      (Vt.prototype.addShapeToModifier = function () {}),
      (Vt.prototype.addShape = function (t) {
        if (!this.closed) {
          t.sh.container.addDynamicProperty(t.sh);
          var e = { shape: t.sh, data: t, localShapeCollection: St.newShapeCollection() };
      ...
      (Rt.prototype.initModifierProperties = function (t, e) {
        ((this.s = mt.getProp(t, e.s, 0, 0.01, this)),
          (this.e = mt.getProp(t, e.e, 0, 0.01, this)),
          (this.o = mt.getProp(t, e.o, 0, 0, this)),
          (this.sValue = 0),
          (this.eValue = 0),
            ...
            if ((c = this.shapes[a]).shape._mdf || this._mdf || t || 2 === this.m) {
              if (((h = (s = c.shape.paths)._length), (f = 0), !c.shape._mdf && c.pathsData.length))
                ...
                for (l = this.releasePathsData(c.pathsData), o = 0; o < h; o += 1)
                  ((p = tt.getSegmentsLength(s.shapes[o])), l.push(p), (f += p.totalLength));
      ...
      (Rt.prototype.addShapes = function (t, e, i) {
        ...
        for (
          ...
          if (
            ...
            break;
          s < m - 1 && ((i = vt.newElement()), (g = !0), u.push(i), (o = 0));
        }
        return u;
      }),
      r([Vt], zt),
      (zt.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          (this.amount = mt.getProp(t, e.a, 0, null, this)),
          (this._isAnimated = !!this.amount.effectsSequence.length));
      }),
      (zt.prototype.processPath = function (t, e) {
        var i = e / 100,
          s = [0, 0],
          a = t._length,
          r = 0;
      ...
      (zt.prototype.processShapes = function (t) {
        var e,
          i,
          s,
          a,
    ...
    var Ot = (function () {
      ...
      function e(t, e, i) {
        if (
          ...
          e.p && e.p.s
            ? ((this.px = mt.getProp(t, e.p.x, 0, 0, this)),
              (this.py = mt.getProp(t, e.p.y, 0, 0, this)),
              e.p.z && (this.pz = mt.getProp(t, e.p.z, 0, 0, this)))
            : (this.p = mt.getProp(t, e.p || { k: [0, 0, 0] }, 1, 0, this)),
          e.rx)
        ) {
          if (
            ((this.rx = mt.getProp(t, e.rx, 0, b, this)),
            (this.ry = mt.getProp(t, e.ry, 0, b, this)),
            (this.rz = mt.getProp(t, e.rz, 0, b, this)),
            e.or.k[0].ti)
          ) {
            var s,
              a = e.or.k.length;
          ...
          ((this.or = mt.getProp(t, e.or, 1, b, this)), (this.or.sh = !0));
        } else this.r = mt.getProp(t, e.r || { k: 0 }, 0, b, this);
        (e.sk &&
          ((this.sk = mt.getProp(t, e.sk, 0, b, this)),
          (this.sa = mt.getProp(t, e.sa, 0, b, this))),
          (this.a = mt.getProp(t, e.a || { k: [0, 0, 0] }, 1, 0, this)),
          (this.s = mt.getProp(t, e.s || { k: [100, 100, 100] }, 1, 0.01, this)),
          e.o ? (this.o = mt.getProp(t, e.o, 0, 0.01, t)) : (this.o = { _mdf: !1, v: 1 }),
          (this._isDirty = !0),
      ...
      return (
        ...
        (e.prototype._addDynamicProperty = ct.prototype.addDynamicProperty),
        {
    ...
    function Xt(t, e, i) {
      return [Wt(t[0], e[0], i), Wt(t[1], e[1], i)];
    }
    function Ht(t, e, i, s) {
      return [3 * e - t - 3 * i + s, 3 * t - 6 * e + 3 * i, -3 * t + 3 * e, t];
    }
    function Yt(t) {
      return new Gt(t, t, t, t, !1);
    }
    function Gt(t, e, i, s, a) {
      (a && ie(t, e) && (e = Xt(t, s, 1 / 3)), a && ie(i, s) && (i = Xt(t, s, 2 / 3)));
      var r = Ht(t[0], e[0], i[0], s[0]),
        n = Ht(t[1], e[1], i[1], s[1]);
      ((this.a = [r[0], n[0]]),
        (this.b = [r[1], n[1]]),
        (this.c = [r[2], n[2]]),
        (this.d = [r[3], n[3]]),
    ...
    function Ut(t) {
      ...
      return [Jt(e[0], t.t1, t.t), Jt(e[1], t.t, t.t2)];
    }
    function Zt(t, e, i, s, a, r) {
      var n, o;
      if (
        ((n = t),
        (o = e),
        ...
        if (i >= r || (t.width <= s && t.height <= s && e.width <= s && e.height <= s))
          ...
          var h = Ut(t),
            l = Ut(e);
          (Zt(h[0], l[0], i + 1, s, a, r),
            Zt(h[0], l[1], i + 1, s, a, r),
            Zt(h[1], l[0], i + 1, s, a, r),
            Zt(h[1], l[1], i + 1, s, a, r));
        }
    }
    function Qt(t, e) {
    ...
    function $t(t, e, i, s) {
      var a = [t[0], t[1], 1],
        ...
        o = [s[0], s[1], 1],
        h = Qt(Qt(a, r), Qt(n, o));
      return jt(h[2]) ? null : [h[0] / h[2], h[1] / h[2]];
    }
    function te(t, e, i) {
    ...
    function ne(t, e, i, s, a, r, n) {
      ...
      ae(t, e.v[i % e._length], o, n, s, d / (2 * (a + 1)), f / (2 * (a + 1)));
    }
    function oe(t, e, i, s, a, r) {
      for (var n = 0; n < s; n += 1) {
        var o = (n + 1) / (s + 1),
          h =
            2 === a
              ...
              : 0,
          l = e.normalAngle(o);
        (ae(t, e.point(o), l, r, i, h / (2 * (s + 1)), h / (2 * (s + 1))), (r = -r));
      }
      return r;
    }
    function he(t, e, i) {
    ...
    function le(t, e) {
      var i, s, a, r, n, o, h;
      ((i = (h = he(t.points[0], t.points[1], e))[0]),
        (s = h[1]),
        (a = (h = he(t.points[1], t.points[2], e))[0]),
        (r = h[1]),
        (n = (h = he(t.points[2], t.points[3], e))[0]),
        (o = h[1]));
      var l = $t(i, s, a, r);
      null === l && (l = s);
      var p = $t(n, o, a, r);
      return (null === p && (p = n), new Gt(i, l, p, o));
    }
    function pe(t, e, i, s, a) {
      var r = e.points[3],
        n = i.points[0];
      if (3 === s) return r;
      if (ie(r, n)) return r;
      if (2 === s) {
        var o = -e.tangentAngle(1),
          ...
          l = $t(r, te(r, o + Math.PI / 2, 100), n, te(n, o + Math.PI / 2, 100)),
          p = l ? ee(l, r) : ee(r, n) / 2,
          f = te(r, o, 2 * p * _);
        return (
      ...
      var d = $t(
        ie(r, e.points[2]) ? e.points[0] : e.points[2],
        r,
        n,
        ie(n, i.points[1]) ? i.points[3] : i.points[1],
      );
      return d && ee(d, r) < a
    ...
    function fe(t, e) {
      ...
      return (i.length && qt(i[0][0], 1) && i.shift(), i.length ? i[0] : null);
    }
    function de(t, e) {
      var i = t.slice(),
        s = e.slice(),
        a = fe(t[t.length - 1], e[0]);
      return (
        a && ((i[t.length - 1] = t[t.length - 1].split(a[0])[0]), (s[0] = e[0].split(a[1])[1])),
        t.length > 1 && e.length > 1 && (a = fe(t[0], e[e.length - 1]))
    ...
    function me(t, e) {
      ...
      if (0 === n.length) return [le(t, e)];
      if (1 === n.length || qt(n[1], 1))
        return ((i = (a = t.split(n[0]))[0]), (s = a[1]), [le(i, e), le(s, e)]);
      i = (a = t.split(n[0]))[0];
      var o = (n[1] - n[0]) / (1 - n[0]);
      return ((r = (a = a[1].split(o))[0]), (s = a[1]), [le(i, e), le(r, e), le(s, e)]);
    }
    function ce() {}
    function ue(t) {
      for (
    ...
    (r([Vt], Nt),
      (Nt.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          (this.c = mt.getProp(t, e.c, 0, null, this)),
          (this.o = mt.getProp(t, e.o, 0, null, this)),
          (this.tr = Ot.getTransformProperty(t, e.tr, this)),
          (this.so = mt.getProp(t, e.tr.so, 0, 0.01, this)),
          (this.eo = mt.getProp(t, e.tr.eo, 0, 0.01, this)),
          (this.data = e),
          this.dynamicProperties.length || this.getValue(!0),
      ...
      (Nt.prototype.applyTransforms = function (t, e, i, s, a, r) {
        var n = r ? -1 : 1,
      ...
      (Nt.prototype.init = function (t, e, i, s) {
        for (
          this.elem = t,
            this.arr = e,
            this.pos = i,
      ...
      (Nt.prototype.resetElements = function (t) {
        var e,
          i = t.length;
        for (e = 0; e < i; e += 1)
          ((t[e]._processed = !1), "gr" === t[e].ty && this.resetElements(t[e].it));
      }),
      (Nt.prototype.cloneElements = function (t) {
        var e = JSON.parse(JSON.stringify(t));
        return (this.resetElements(e), e);
      }),
      (Nt.prototype.changeGroupRender = function (t, e) {
        var i,
          s = t.length;
        for (i = 0; i < s; i += 1)
      ...
      r([Vt], Bt),
      (Bt.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          (this.rd = mt.getProp(t, e.r, 0, null, this)),
      ...
      (Gt.prototype.point = function (t) {
        return [
          ((this.a[0] * t + this.b[0]) * t + this.c[0]) * t + this.d[0],
          ((this.a[1] * t + this.b[1]) * t + this.c[1]) * t + this.d[1],
        ];
      }),
      (Gt.prototype.derivative = function (t) {
        return [
          (3 * t * this.a[0] + 2 * this.b[0]) * t + this.c[0],
          (3 * t * this.a[1] + 2 * this.b[1]) * t + this.c[1],
        ];
      }),
      (Gt.prototype.tangentAngle = function (t) {
        var e = this.derivative(t);
        return Math.atan2(e[1], e[0]);
      }),
      (Gt.prototype.normalAngle = function (t) {
        var e = this.derivative(t);
        return Math.atan2(e[0], e[1]);
      }),
      (Gt.prototype.inflectionPoints = function () {
      ...
      (Gt.prototype.split = function (t) {
        if (t <= 0) return [Yt(this.points[0]), this];
        if (t >= 1) return [this, Yt(this.points[this.points.length - 1])];
        var e = Xt(this.points[0], this.points[1], t),
          i = Xt(this.points[1], this.points[2], t),
          s = Xt(this.points[2], this.points[3], t),
          a = Xt(e, i, t),
          r = Xt(i, s, t),
          n = Xt(a, r, t);
        return [new Gt(this.points[0], e, a, n, !0), new Gt(n, r, s, this.points[3], !0)];
      }),
      (Gt.prototype.bounds = function () {
        return { x: Kt(this, 0), y: Kt(this, 1) };
      }),
      (Gt.prototype.boundingBox = function () {
        var t = this.bounds();
        return {
          left: t.x.min,
          right: t.x.max,
      ...
      (Gt.prototype.intersections = function (t, e, i) {
        (void 0 === e && (e = 2), void 0 === i && (i = 7));
        var s = [];
        return (Zt(Jt(this, 0, 1), Jt(t, 0, 1), 0, e, s, i), s);
      }),
      (Gt.shapeSegment = function (t, e) {
        var i = (e + 1) % t.length();
        return new Gt(t.v[e], t.o[e], t.i[i], t.v[i], !0);
      }),
      (Gt.shapeSegmentInverted = function (t, e) {
        var i = (e + 1) % t.length();
        return new Gt(t.v[i], t.i[i], t.o[e], t.v[e], !0);
      }),
      r([Vt], se),
      (se.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          (this.amplitude = mt.getProp(t, e.s, 0, null, this)),
          (this.frequency = mt.getProp(t, e.r, 0, null, this)),
          (this.pointsType = mt.getProp(t, e.pt, 0, null, this)),
          (this._isAnimated =
      ...
      (se.prototype.processPath = function (t, e, i, s) {
        ...
        var n = -1,
          o = Gt.shapeSegment(t, 0);
        ne(r, t, 0, e, i, s, n);
        for (var h = 0; h < a; h += 1)
          ((n = oe(r, o, e, i, s, -n)),
            (o = h !== a - 1 || t.c ? Gt.shapeSegment(t, (h + 1) % a) : null),
            ne(r, t, h + 1, e, i, s, n));
        return r;
      }),
      ...
      r([Vt], ce),
      (ce.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          (this.amount = mt.getProp(t, e.a, 0, null, this)),
          (this.miterLimit = mt.getProp(t, e.ml, 0, null, this)),
          (this.lineJoin = e.lj),
      ...
      (ce.prototype.processPath = function (t, e, i, s) {
        ...
        t.c || (h -= 1);
        var l = [];
        for (r = 0; r < h; r += 1) ((o = Gt.shapeSegment(t, r)), l.push(me(o, e)));
        if (!t.c)
          for (r = h - 1; r >= 0; r -= 1) ((o = Gt.shapeSegmentInverted(t, r)), l.push(me(o, e)));
        l = (function (t) {
          for (var e, i = 1; i < t.length; i += 1)
            ((e = de(t[i - 1], t[i])), (t[i - 1] = e[0]), (t[i] = e[1]));
          return (
            t.length > 1 &&
              ((e = de(t[t.length - 1], t[0])), (t[t.length - 1] = e[0]), (t[0] = e[1])),
            t
          );
        })(l);
        var p = null,
        ...
        for (r = 0; r < l.length; r += 1) {
          var d = l[r];
          for (f && (p = pe(a, f, d[0], i, s)), f = d[d.length - 1], n = 0; n < d.length; n += 1)
            ((o = d[n]),
              p && ie(o.points[0], p)
        ...
        return (l.length && pe(a, f, l[0][0], i, s), a);
      }),
    ...
    function ke(t, e, i) {
      this.p = mt.getProp(e, t.v, 0, 0, i);
    }
    function Pe(t, e, i) {
      this.p = mt.getProp(e, t.v, 0, 0, i);
    }
    function Ae(t, e, i) {
      this.p = mt.getProp(e, t.v, 1, 0, i);
    }
    function Se(t, e, i) {
      this.p = mt.getProp(e, t.v, 1, 0, i);
    }
    ...
    function Le(t, e, i) {
      ...
      ((this.audio = this.globalData.audioController.createAudio(s)),
        ...
        (this.tm = t.tm ? mt.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 }),
        (this.lv = mt.getProp(this, t.au && t.au.lv ? t.au.lv : { k: [100] }, 1, 0.01, this)));
    }
    function Ve() {}
    (r([ct], Te),
      ...
      (Fe.prototype = {
        ...
        initBaseData: function (t, e, i) {
          ((this.globalData = e),
            ...
            (this.effectsManager = new Me(this.data, this, this.dynamicProperties)));
        },
        getType: function () {
          return this.type;
        },
      ...
      (Ie.prototype.prepareFrame = function () {}),
      r([ve, Fe, Ee], Ie),
      (Ie.prototype.getBaseElement = function () {
        return null;
      }),
      (Ie.prototype.renderFrame = function () {}),
      (Ie.prototype.destroy = function () {}),
      (Ie.prototype.initExpressions = function () {}),
      (Ie.prototype.getFootageData = function () {
        return this.footageData;
      }),
      (Le.prototype.prepareFrame = function (t) {
        if (
      ...
      (Le.prototype.setRate = function (t) {
        this.audio.rate(t);
      }),
      (Le.prototype.volume = function (t) {
        ((this._volumeMultiplier = t),
          (this._previousVolume = t * this._volume),
          this.audio.volume(this._previousVolume));
      }),
      (Le.prototype.getBaseElement = function () {
        return null;
      }),
      (Le.prototype.destroy = function () {}),
      (Le.prototype.sourceRectAtTime = function () {}),
      (Le.prototype.initExpressions = function () {}),
      (Ve.prototype.checkLayers = function (t) {
        var e,
          i,
      ...
      (Ve.prototype.setupGlobalData = function (t, e) {
        ((this.globalData.fontManager = new ge()),
    ...
    function Oe(t, e, i) {
      ...
      for (a = 0; a < o; a += 1)
        if (
          ...
          ("s" !== u[a].mode && "i" !== u[a].mode) || 0 !== g
            ? (f = null)
            : ((f = O("rect")).setAttribute("fill", "#ffffff"),
          ...
          ((this.viewData[a] = {
            op: mt.getProp(this.element, u[a].o, 0, 0.01, this.element),
            prop: xt.getShapeProp(this.element, u[a], 3),
            elem: r,
            lastPath: "",
          }),
            n.appendChild(r));
          ...
          if (
            ...
            0 !== u[a].x.k
              ? ((b = "mask"),
                (_ = "mask"),
                (c = mt.getProp(this.element, u[a].x, 0, null, this.element)),
                (k = M()),
                (d = O("filter")).setAttribute("id", k),
                (m = O("feMorphology")).setAttribute("operator", "erode"),
      ...
      for (this.maskElement = O(b), o = y.length, a = 0; a < o; a += 1)
    ...
    ((ze.prototype = {
      initTransform: function () {
        var t = new wt();
        ((this.finalTransform = {
          mProp: this.data.ks ? Ot.getTransformProperty(this, this.data.ks, this) : { o: 0 },
          _matMdf: !1,
          _localMatMdf: !1,
          _opMdf: !1,
          mat: t,
      ...
      searchEffectTransforms: function () {
        if (this.renderableEffectsManager) {
          var t = this.renderableEffectsManager.getEffects(Re);
          if (t.length) {
            ((this.localTransforms = []), (this.finalTransform.localMat = new wt()));
            var e = 0,
              i = t.length;
    ...
    function We(t) {
      var e,
        ...
        n = M(),
        o = Ne.createFilter(n, !0),
        h = 0;
      for (this.filters = [], e = 0; e < r; e += 1) {
        i = null;
        var l = t.data.ef[e].ty;
        (qe[l] &&
          ((i = new (0, qe[l].effect)(o, t.effectsManager.effectElements[e], t, je + h, a)),
          (a = je + h),
          qe[l].countsAsEffect && (h += 1)),
    ...
    ((We.prototype.renderFrame = function (t) {
      ...
      (We.prototype.getEffects = function (t) {
        var e,
          i = this.filters.length,
          s = [];
      ...
      (Xe.prototype = {
        ...
        createRenderableComponents: function () {
          ((this.maskManager = new Oe(this.data, this, this.globalData)),
            (this.renderableEffectsManager = new We(this)),
        ...
        getMatte: function (t) {
          if ((this.matteMasks || (this.matteMasks = {}), !this.matteMasks[t])) {
            ...
            if (1 === t || 3 === t) {
              ...
              var l = O("g");
              (h.appendChild(l), (e = M()), (i = Ne.createFilter(e)));
              var p = O("feComponentTransfer");
    ...
    var Ue = { 1: "butt", 2: "round", 3: "square" },
      Ze = { 1: "miter", 2: "round", 3: "bevel" };
    function Qe(t, e, i) {
      ((this.caches = []),
        (this.styles = []),
        (this.transformers = t),
    ...
    function ei(t, e, i) {
      (this.initDynamicPropertyContainer(t),
        ...
        (this.o = mt.getProp(t, e.o, 0, 0.01, this)),
        (this.w = mt.getProp(t, e.w, 0, null, this)),
        (this.d = new ti(t, e.d || {}, "svg", this)),
        (this.c = mt.getProp(t, e.c, 1, 255, this)),
        (this.style = i),
    ...
    function ai(t, e, i) {
      ...
      ((this.o = h("float32", s)),
        ...
        (this.prop = mt.getProp(t, e.k, 1, null, this)),
        (this.k = this.prop.k),
        this.getValue(!0));
    }
    function ri(t, e, i) {
    ...
    ((Qe.prototype.setAsAnimated = function () {
      this._isAnimated = !0;
    }),
      ...
      r([ct], ii),
      r([ct], si),
      (ai.prototype.comparePoints = function (t, e) {
      ...
      (ai.prototype.checkCollapsable = function () {
      ...
      (ai.prototype.getValue = function (t) {
        if (
          (this.prop.getValue(),
          (this._mdf = !1),
          (this._cmdf = !1),
      ...
      r([ct], ai),
      (ri.prototype.initGradientData = function (t, e, i) {
        ((this.o = mt.getProp(t, e.o, 0, 0.01, this)),
          (this.s = mt.getProp(t, e.s, 1, null, this)),
          (this.e = mt.getProp(t, e.e, 1, null, this)),
          (this.h = mt.getProp(t, e.h || { k: 0 }, 0, 0.01, this)),
          (this.a = mt.getProp(t, e.a || { k: 0 }, 0, b, this)),
          (this.g = new ai(t, e.g, this)),
          (this.style = i),
          (this.stops = []),
      ...
      (ri.prototype.setGradientData = function (t, e) {
        var i = M(),
          a = O(1 === e.t ? "linearGradient" : "radialGradient");
        (a.setAttribute("id", i),
        ...
        var r,
          ...
          o,
          h = [];
        for (o = 4 * e.g.p, n = 0; n < o; n += 4) ((r = O("stop")), a.appendChild(r), h.push(r));
        (t.setAttribute("gf" === e.ty ? "fill" : "stroke", "url(" + s() + "#" + i + ")"),
          (this.gf = a),
          (this.cst = h));
      }),
      (ri.prototype.setGradientOpacity = function (t, e) {
        if (this.g._hasOpacity && !this.g._collapsable) {
          ...
          var h = M(),
            l = M();
          n.setAttribute("id", l);
          var p = O(1 === t.t ? "linearGradient" : "radialGradient");
          (p.setAttribute("id", h),
          ...
          for (a = 4 * t.g.p; a < r; a += 2)
            ((i = O("stop")).setAttribute("stop-color", "rgb(255,255,255)"),
              p.appendChild(i),
              f.push(i));
          (o.setAttribute("gf" === t.ty ? "fill" : "stroke", "url(" + s() + "#" + h + ")"),
            "gs" === t.ty &&
              (o.setAttribute("stroke-linecap", Ue[t.lc || 2]),
              o.setAttribute("stroke-linejoin", Ze[t.lj || 2]),
        ...
        function a(i, s, a) {
          ...
          for (p = 0; p < u; p += 1) {
            ...
            if (((n = (f = s.sh.paths)._length), h)) {
              for (o = "", r = 0; r < n; r += 1)
                (l = f.shapes[r]) && l._length && (o += li(l, l._length, l.c, d));
              s.caches[p] = o;
            } else o = s.caches[p];
        ...
        function r(t, e, i) {
          ...
          ((e.c._mdf || i) &&
            s.pElem.setAttribute(
              "fill",
              "rgb(" + g(e.c.v[0]) + "," + g(e.c.v[1]) + "," + g(e.c.v[2]) + ")",
            ),
    ...
    (r([Fe, ze, Xe, Je, He, Ee, Ye], fi),
      (fi.prototype.initSecondaryElement = function () {}),
      (fi.prototype.identityMatrix = new wt()),
      (fi.prototype.buildExpressionInterface = function () {}),
      (fi.prototype.createContent = function () {
        (this.searchShapes(
          this.shapesData,
          this.itemsData,
          this.prevViewData,
      ...
      (fi.prototype.filterUniqueShapes = function () {
        var t,
          e,
          i,
          s,
      ...
      (fi.prototype.setShapesAsAnimated = function (t) {
        var e,
          i = t.length;
        for (e = 0; e < i; e += 1) t[e].setAsAnimated();
      }),
      (fi.prototype.createStyleElement = function (t, e) {
        var i,
          a = new $e(t, e),
          r = a.pElem;
        return (
          "st" === t.ty
            ...
            : "fl" === t.ty
              ? (i = new ii(this, t, a))
              : "gf" === t.ty || "gs" === t.ty
                ? ((i = new ("gf" === t.ty ? ri : ni)(this, t, a)),
                  this.globalData.defs.appendChild(i.gf),
                  i.maskId &&
                    (this.globalData.defs.appendChild(i.ms),
                    this.globalData.defs.appendChild(i.of),
                    r.setAttribute("mask", "url(" + s() + "#" + i.maskId + ")")))
                : "no" === t.ty && (i = new si(this, t, a)),
          ("st" !== t.ty && "gs" !== t.ty) ||
            (r.setAttribute("stroke-linecap", Ue[t.lc || 2]),
            r.setAttribute("stroke-linejoin", Ze[t.lj || 2]),
          ...
          t.bm && (r.style["mix-blend-mode"] = _e(t.bm)),
          this.stylesList.push(a),
          this.addToAnimatedContents(t, i),
          i
        );
      }),
      (fi.prototype.createGroupElement = function (t) {
        var e = new oi();
        return (
          t.ln && e.gr.setAttribute("id", t.ln),
          t.cl && e.gr.setAttribute("class", t.cl),
          t.bm && (e.gr.style["mix-blend-mode"] = _e(t.bm)),
          e
        );
      }),
      (fi.prototype.createTransformElement = function (t, e) {
        var i = Ot.getTransformProperty(this, t, this),
          s = new hi(i, i.o, e);
        return (this.addToAnimatedContents(t, s), s);
      }),
      (fi.prototype.createShapeElement = function (t, e, i) {
        var s = 4;
        "rc" === t.ty ? (s = 5) : "el" === t.ty ? (s = 6) : "sr" === t.ty && (s = 7);
        var a = new Qe(e, i, xt.getShapeProp(this, t, s, this));
        return (
          this.shapes.push(a),
      ...
      (fi.prototype.addToAnimatedContents = function (t, e) {
        for (var i = 0, s = this.animatedContents.length; i < s;) {
          if (this.animatedContents[i].element === e) return;
          i += 1;
        }
        this.animatedContents.push({ fn: pi.createRenderFunction(t), element: e, data: t });
      }),
      (fi.prototype.setElementStyles = function (t) {
        var e,
          i = t.styles,
      ...
      (fi.prototype.reloadShapes = function () {
        var t;
        this._isFirstFrame = !0;
      ...
      (fi.prototype.searchShapes = function (t, e, i, s, a, r, n) {
        var o,
          h,
          l,
          p,
            ...
            "tr" === t[o].ty
              ...
              : "sh" === t[o].ty || "rc" === t[o].ty || "el" === t[o].ty || "sr" === t[o].ty
                ...
                : "tm" === t[o].ty ||
                  ...
                  ? (d
                      ? ((f = e[o]).closed = !1)
                      : ((f = Lt.getModifier(t[o].ty)).init(this, t[o]),
                        (e[o] = f),
      ...
      (fi.prototype.renderInnerContent = function () {
        var t;
        this.renderModifiers();
      ...
      (fi.prototype.renderShape = function () {
        var t,
          e,
      ...
      (di.prototype.update = function (t, e, i, s, a, r) {
        ((this._mdf.o = !1),
          (this._mdf.sw = !1),
          (this._mdf.sc = !1),
          (this._mdf.fc = !1),
      ...
      (mi.prototype.defaultBoxWidth = [0, 0]),
      (mi.prototype.copyData = function (t, e) {
        for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (t[i] = e[i]);
        return t;
      }),
      (mi.prototype.setCurrentData = function (t) {
        (t.__complete || this.completeTextData(t),
          (this.currentData = t),
          (this.currentData.boxWidth = this.currentData.boxWidth || this.defaultBoxWidth),
          (this._mdf = !0));
      }),
      (mi.prototype.searchProperty = function () {
        return this.searchKeyframes();
      }),
      (mi.prototype.searchKeyframes = function () {
        return (
      ...
      (mi.prototype.addEffect = function (t) {
      ...
      (mi.prototype.getKeyframeValue = function () {
        for (
      ...
      (mi.prototype.buildFinalText = function (t) {
        for (var e, i, s = [], a = 0, r = t.length, n = !1, o = !1, h = ""; a < r;)
          ((n = o),
            (o = !1),
            (e = t.charCodeAt(a)),
            (h = t.charAt(a)),
            ge.isCombinedCharacter(e)
              ? (n = !0)
              : e >= 55296 && e <= 56319
                ? ge.isRegionalFlag(t, a)
                  ? (h = t.substr(a, 14))
                  : (i = t.charCodeAt(a + 1)) >= 56320 &&
                    i <= 57343 &&
                    (ge.isModifier(e, i)
                      ? ((h = t.substr(a, 2)), (n = !0))
                      : (h = ge.isFlagEmoji(t.substr(a, 4)) ? t.substr(a, 4) : t.substr(a, 2)))
                : e > 56319
                  ? ((i = t.charCodeAt(a + 1)), ge.isVariationSelector(e) && (n = !0))
                  : ge.isZeroWidthJoiner(e) && ((n = !0), (o = !0)),
            n ? ((s[s.length - 1] += h), (n = !1)) : s.push(h),
            (a += h.length));
        return s;
      }),
      (mi.prototype.completeTextData = function (t) {
        t.__complete = !0;
        var e,
          i,
          s,
      ...
      (mi.prototype.updateDocumentData = function (t, e) {
      ...
      (mi.prototype.recalculate = function (t) {
        var e = this.data.d.k[t].s;
        ((e.__complete = !1), (this.keysIndex = 0), (this._isFirstFrame = !0), this.getValue(e));
      }),
      (mi.prototype.canResizeFont = function (t) {
        ((this.canResize = t),
          this.recalculate(this.keysIndex),
          this.elem.addDynamicProperty(this));
      }),
      (mi.prototype.setMinimumFontSize = function (t) {
    ...
    var ci = (function () {
      ...
      function s(t, e) {
        ((this._currentTextLength = -1),
          ...
          (this.finalE = 0),
          this.initDynamicPropertyContainer(t),
          (this.s = mt.getProp(t, e.s || { k: 0 }, 0, 0, this)),
          (this.e = "e" in e ? mt.getProp(t, e.e, 0, 0, this) : { v: 100 }),
          (this.o = mt.getProp(t, e.o || { k: 0 }, 0, 0, this)),
          (this.xe = mt.getProp(t, e.xe || { k: 0 }, 0, 0, this)),
          (this.ne = mt.getProp(t, e.ne || { k: 0 }, 0, 0, this)),
          (this.sm = mt.getProp(t, e.sm || { k: 100 }, 0, 0, this)),
          (this.a = mt.getProp(t, e.a, 0, 0.01, this)),
      ...
      return (
        (s.prototype = {
          getMult: function (s) {
            ...
            var h = J.getBezierEasing(a, r, n, o).get,
              l = 0,
              p = this.finalS,
              f = this.finalE,
              d = this.data.sh;
            if (2 === d)
              l = h(
                (l = f === p ? (s >= f ? 1 : 0) : t(0, e(0.5 / (f - p) + (s - p) / (f - p), 1))),
              );
            else if (3 === d)
              l = h(
                (l =
                  f === p ? (s >= f ? 0 : 1) : 1 - t(0, e(0.5 / (f - p) + (s - p) / (f - p), 1))),
              );
            else if (4 === d)
              (f === p
                ? (l = 0)
    ...
    function ui(t, e, i) {
      var s = { propType: !1 },
        ...
        r = e.a;
      ((this.a = {
        r: r.r ? a(t, r.r, 0, b, i) : s,
        rx: r.rx ? a(t, r.rx, 0, b, i) : s,
        ry: r.ry ? a(t, r.ry, 0, b, i) : s,
        sk: r.sk ? a(t, r.sk, 0, b, i) : s,
        sa: r.sa ? a(t, r.sa, 0, b, i) : s,
        ...
        (this.s = ci.getTextSelectorProp(t, e.s, i)),
        (this.s.t = e.s.t));
    }
    function gi(t, e, i) {
      ((this._isFirstFrame = !0),
    ...
    function yi() {}
    ((gi.prototype.searchProperties = function () {
      var t,
        e,
        i = this._textData.a.length,
        s = mt.getProp;
      for (t = 0; t < i; t += 1)
        ((e = this._textData.a[t]), (this._animatorsData[t] = new ui(this._elem, e, this)));
      ...
      (gi.prototype.getMeasures = function (t, e) {
        if (
              ...
              if (D[a].n) {
                ...
                for (F = 0; F < V; F += 1)
                  (T = P[F].a).t.propType &&
                    ...
                    (z = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length
                      ? (nt += T.t.v * z[0] * ht)
                      : (nt += T.t.v * z * ht));
                pt = !1;
              }
          ...
          for (a = 0; a < r; a += 1) {
            if ((S.reset(), (W = 1), D[a].n))
              ...
              if (this._hasMaskedPath) {
                ...
                for (
                  p = !0,
                    this._pathData.a.v &&
                      ((o =
                        0.5 * D[0].an +
                        ((y - this._pathData.f.v - 0.5 * D[0].an - 0.5 * D[D.length - 1].an) * Q) /
                          (r - 1)),
                      (o += this._pathData.f.v));
                  p;
                )
                  l + g >= o + ft || !c
                    ? ((v = (o + ft - l) / h.partialLength),
                      ...
                      S.translate(-k[0] * D[a].an * 0.005, -k[1] * O * 0.01),
                      (p = !1))
                    : c &&
                      ((l += h.partialLength),
                      (f += 1) >= c.length &&
                ...
                ((B = D[a].an / 2 - D[a].add),
                  S.translate(-B, 0, 0),
                  S.translate(-k[0] * D[a].an * 0.005, -k[1] * O * 0.01, 0));
              for (F = 0; F < V; F += 1)
                (T = P[F].a).t.propType &&
                  ((z = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)),
                  (0 === i && 0 === t.j) ||
                    (this._hasMaskedPath
                      ? z.length
                        ? (o += T.t.v * z[0])
              ...
              for (
                ...
                (T = P[F].a).a.propType &&
                  ((z = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length
                    ? S.translate(-T.a.v[0] * z[0], -T.a.v[1] * z[1], T.a.v[2] * z[2])
                    : S.translate(-T.a.v[0] * z, -T.a.v[1] * z, T.a.v[2] * z));
              for (F = 0; F < V; F += 1)
                (T = P[F].a).s.propType &&
                  ((z = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length
                    ? S.scale(1 + (T.s.v[0] - 1) * z[0], 1 + (T.s.v[1] - 1) * z[1], 1)
                    : S.scale(1 + (T.s.v[0] - 1) * z, 1 + (T.s.v[1] - 1) * z, 1));
              for (F = 0; F < V; F += 1) {
                if (
                  ((T = P[F].a),
                  (z = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)),
                  T.sk.propType &&
                    (z.length
                      ? S.skewFromAxis(-T.sk.v * z[0], T.sa.v * z[1])
                      : S.skewFromAxis(-T.sk.v * z, T.sa.v * z)),
                  T.r.propType && (z.length ? S.rotateZ(-T.r.v * z[2]) : S.rotateZ(-T.r.v * z)),
                  T.ry.propType && (z.length ? S.rotateY(T.ry.v * z[1]) : S.rotateY(T.ry.v * z)),
                  T.rx.propType && (z.length ? S.rotateX(T.rx.v * z[0]) : S.rotateX(T.rx.v * z)),
                  T.o.propType &&
                    (z.length ? (W += (T.o.v * z[0] - W) * z[0]) : (W += (T.o.v * z - W) * z)),
                  t.strokeWidthAnim &&
                    T.sw.propType &&
                    (z.length ? (H += T.sw.v * z[0]) : (H += T.sw.v * z)),
                  t.strokeColorAnim && T.sc.propType)
                )
                  for (G = 0; G < 3; G += 1)
                    z.length
                      ? (X[G] += (T.sc.v[G] - X[G]) * z[0])
                      : (X[G] += (T.sc.v[G] - X[G]) * z);
                if (t.fillColorAnim && t.fc) {
                  if (T.fc.propType)
                    for (G = 0; G < 3; G += 1)
                      z.length
                        ? (Y[G] += (T.fc.v[G] - Y[G]) * z[0])
                        : (Y[G] += (T.fc.v[G] - Y[G]) * z);
                  (T.fh.propType && (Y = z.length ? L(Y, T.fh.v * z[0]) : L(Y, T.fh.v * z)),
                    T.fs.propType && (Y = z.length ? E(Y, T.fs.v * z[0]) : E(Y, T.fs.v * z)),
                    T.fb.propType && (Y = z.length ? I(Y, T.fb.v * z[0]) : I(Y, T.fb.v * z)));
                }
              }
              for (F = 0; F < V; F += 1)
                (T = P[F].a).p.propType &&
                  ...
                  this._hasMaskedPath
                    ? z.length
                      ? S.translate(0, T.p.v[1] * z[0], -T.p.v[2] * z[1])
                      : S.translate(0, T.p.v[1] * z, -T.p.v[2] * z)
                    : z.length
                      ? S.translate(T.p.v[0] * z[0], T.p.v[1] * z[1], -T.p.v[2] * z[2])
                      : S.translate(T.p.v[0] * z, T.p.v[1] * z, -T.p.v[2] * z));
              if (
            ...
            w <= a
              ? ((R = new di(Z, K, J, U, at, rt)),
                this.renderedLetters.push(R),
                (w += 1),
                (this.lettersChangedFlag = !0))
              : ((R = this.renderedLetters[a]),
                (this.lettersChangedFlag =
                  R.update(Z, K, J, U, at, rt) || this.lettersChangedFlag));
          }
        }
      }),
      ...
      (gi.prototype.mHelper = new wt()),
      (gi.prototype.defaultPropsArray = []),
      r([ct], gi),
      (yi.prototype.initElement = function (t, e, i) {
        ((this.lettersChangedFlag = !0),
          this.initFrame(),
          this.initBaseData(t, e, i),
          (this.textProperty = new mi(this, t.t, this.dynamicProperties)),
          (this.textAnimator = new gi(t.t, this.renderType, this)),
          this.initTransform(t, e, i),
          this.initHierarchy(),
          this.initRenderable(),
          this.initRendererElement(),
      ...
      (yi.prototype.createPathShape = function (t, e) {
        var i,
          ...
          r = "";
        for (i = 0; i < a; i += 1)
          "sh" === e[i].ty && ((s = e[i].ks.k), (r += li(s, s.i.length, !0, t)));
        return r;
      }),
      ...
      (yi.prototype.applyTextPropertiesToMatrix = function (t, e, i, s, a) {
        switch (
    ...
    return (
      r([Fe, ze, Xe, He, Ee, Ye, yi], _i),
      (_i.prototype.createContent = function () {
        this.data.singleShape &&
          !this.globalData.fontManager.chars &&
          (this.textContainer = O("text"));
      }),
        ...
        if (!f || h || i.sz) {
          ...
          for (t = 0; t < e; t += 1) {
            if (
              ...
              if (((n = y > t ? this.textSpans[t].span : O(h ? "g" : "text")), y <= t)) {
                if (
            ...
            if (
              ...
              if (
                ...
                b = new xi(g.data, this.globalData, this);
              else {
                var _ = bi;
                (g.data && g.data.shapes && (_ = this.buildShapeData(g.data, i.finalSize)),
                  (b = new fi(_, this.globalData, this)));
              }
              ...
              (f &&
                n.setAttribute("transform", "translate(" + p.props[12] + "," + p.props[13] + ")"),
          ...
          for (e = S.length, m = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1)
            (((n = this.textSpans[t].span || O("tspan")).textContent = S[t]),
              n.setAttribute("x", 0),
              n.setAttribute("y", m),
              (n.style.display = "inherit"),
              P.appendChild(n),
      ...
      r([Fe, ze, He, Ee], Pi),
      r([Ve], Ai),
      (Ai.prototype.createNull = function (t) {
        return new Pi(t, this.globalData, this);
      }),
      (Ai.prototype.createShape = function (t) {
        return new fi(t, this.globalData, this);
      }),
      (Ai.prototype.createText = function (t) {
        return new _i(t, this.globalData, this);
      }),
      (Ai.prototype.createImage = function (t) {
        return new Ge(t, this.globalData, this);
      }),
      (Ai.prototype.createSolid = function (t) {
        return new ki(t, this.globalData, this);
      }),
      (Ai.prototype.configAnimation = function (t) {
      ...
      (Ai.prototype.updateContainerSize = function () {}),
      (Ai.prototype.findIndexByInd = function (t) {
        var e = 0,
          i = this.layers.length;
        for (e = 0; e < i; e += 1) if (this.layers[e].ind === t) return e;
        return -1;
      }),
      (Ai.prototype.buildItem = function (t) {
        var e = this.elements;
      ...
      (Ai.prototype.checkPendingElements = function () {
      ...
      (Ai.prototype.appendElementInPos = function (t, e) {
      ...
      r([Fe, ze, He, Ee, Ye], Si),
      (Si.prototype.initElement = function (t, e, i) {
        (this.initFrame(),
          this.initBaseData(t, e, i),
          this.initTransform(t, e, i),
          this.initRenderable(),
      ...
      (Si.prototype.setElements = function (t) {
        this.elements = t;
      }),
      (Si.prototype.getElements = function () {
        return this.elements;
      }),
      (Si.prototype.destroyElements = function () {
        var t,
          e = this.layers.length;
      ...
      r([Ai, Si, Xe], xi),
      (xi.prototype.createComp = function (t) {
        return new xi(t, this.globalData, this);
      }),
      r([Ai], wi),
      (wi.prototype.createComp = function (t) {
        return new xi(t, this.globalData, this);
      }),
      (vi = wi),
      (H.svg = vi),
      Lt.registerModifier("tm", Rt),
      Lt.registerModifier("pb", zt),
      Lt.registerModifier("rp", Nt),
      Lt.registerModifier("rd", Bt),
      Lt.registerModifier("zz", se),
      Lt.registerModifier("op", ce),
      Ct
    );
  }),
